...
INSERT INTO `t_course`(`course_number`, `name`, `learn_hours`, `credit`, `pre_course`) VALUE(5,'C++',78,3,NULL);
...
-- 添加学生
INSERT INTO `t_student`(`student_number`, `name`, `gender`, `native_place`, `class_name_id`, `scholarship_level`) VALUE(1,'张三','男','北京市','1',NULL);
INSERT INTO `t_student`(`student_number`, `name`, `gender`, `native_place`, `class_name_id`, `scholarship_level`) VALUE(2,'李四','女','天津市','1',NULL);
INSERT INTO `t_student`(`student_number`, `name`, `gender`, `native_place`, `class_name_id`, `scholarship_level`) VALUE(3,'王五','女','北京市','2',NULL);
INSERT INTO `t_student`(`student_number`, `name`, `gender`, `native_place`, `class_name_id`, `scholarship_level`) VALUE(4,'刘一','男','天津市','2',NULL);
INSERT INTO `t_student`(`student_number`, `name`, `gender`, `native_place`, `class_name_id`, `scholarship_level`) VALUE(5,'陈二','男','黑龙江省','3',NULL);
INSERT INTO `t_student`(`student_number`, `name`, `gender`, `native_place`, `class_name_id`, `scholarship_level`) VALUE(6,'赵六','男','黑龙江省','3',NULL);
INSERT INTO `t_student`(`student_number`, `name`, `gender`, `native_place`, `class_name_id`, `scholarship_level`) VALUE(7,'孙七','男','黑龙江省','3',NULL);
INSERT INTO `t_student`(`student_number`, `name`, `gender`, `native_place`, `class_name_id`, `scholarship_level`) VALUE(8,'周八','男','台湾省','4',NULL);
INSERT INTO `t_student`(`student_number`, `name`, `gender`, `native_place`, `class_name_id`, `scholarship_level`) VALUE(9,'吴九','男','台湾省','4',NULL);
INSERT INTO `t_student`(`student_number`, `name`, `gender`, `native_place`, `class_name_id`, `scholarship_level`) VALUE(10,'郑十','男','台湾省','4',NULL);
