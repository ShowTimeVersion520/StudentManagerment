...
INSERT INTO `t_sys_user` (`id`, `username`, `password`, `enabled`) VALUES
  (1, 'lvxin', 'b8053fb0d3f859d7d36b7034ad332c1335a9fae1e4750937488ef3f8d64306c22640849647e542ba', 1),
  (2, 'admin', 'a66298cf223f037bfa18c982b1162aa84781c3f05f839fa927bbd5e813aafd43fabc68ed1c4622a8', 1),
  (3, 'guest', '3d01267fab76c23ecb04d1cd646633aa43019b461e23dcfe6eb4e2c3e7e7be6163ac3d3c39a5205b', 1);
...
INSERT INTO `t_sys_role` (`id`, `english_name`, `chinese_name`, `description`, `enabled`) VALUES
  (1, 'ADMIN', '管理员', '管理员', 1),
  (2, 'ADMIN', '运维人员', '运维人员', 1),
  (3, 'USER', '用户', '用户', 1);
...
INSERT INTO `t_sys_authority` (`id`, `name`, `description`, `enabled`) VALUES
  (1, '后台账号管理', '后台账号管理', 1),
  (2, '角色/权限管理', '角色/权限管理', 1);
