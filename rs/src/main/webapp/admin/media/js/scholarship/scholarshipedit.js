...
// 定义全局变量
// User
var apiUrlUser = "/api/v1/scholarships";//TODO:this
// // Authority
...
app.controller('form', ['$scope', '$location', '$http', '$window', function($scope, $location, $http, $window){
    ...
    $scope.submit = function () {
        ...
        $http({
            ...
            // 设置跳转
            redirectToUrl("/admin/scholarship/index.html", redirectTime);//TODO:this
...
//    $http({
//    method: 'GET',
//    url:"/api/v1/scholarships/scholarshipLevels/all"
//    }).then(function successCallback(response) {
