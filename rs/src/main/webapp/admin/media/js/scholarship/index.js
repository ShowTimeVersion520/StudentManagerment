...
// 全局变量
var apiUrl = "/api/v1/scholarships";//TODO:this
...
//    $http({
//    method: 'GET',
//    url:"/api/v1/scholarships/scholarship_levels/all"
//    }).then(function successCallback(response) {
//    $scope.scholarship_levels = response.data.data;
//    $scope.process = "";
...
//    $http({
//    method: 'GET',
//    url:"/api/v1/scholarships/moneys/all"
//    }).then(function successCallback(response) {
//    $scope.moneys = response.data.data;
//    $scope.process = "";
//    }, function errorCallback(response) {
//    $scope.process = "提交数据失败！";
//    });
    // 定义form的数据存储地方
    $scope.formData = {
        list: 3 // 初始化select的值，1为启用，参考 $scope.enableds
                    //,scholarship_level:""
                    //,money:""
            };
        ...
        table.bootstrapTable({
            ...
            events: {
                ...
                'click .edit': function(e, value, row, index) {
                    //formatter中点击删除按钮事件
                    //机制：click表示点击，.remove表示class名
                    window.location.href = "/admin/scholarship/scholarshipedit.html?id=" + row.id;//TODO:this
                },
            }
        }, ]
    });
