...
// 全局变量
var apiUrl = "/api/v1/courses";//TODO:this
...
//    $http({
//    method: 'GET',
//    url:"/api/v1/courses/courseNumbers/all"
...
//    $http({
//    method: 'GET',
//    url:"/api/v1/courses/learnHourss/all"
//    }).then(function successCallback(response) {
//    $scope.learnHourss = response.data.data;
//    $scope.process = "";
//    }, function errorCallback(response) {
//    $scope.process = "提交数据失败！";
//    });
//    $http({
//    method: 'GET',
//    url:"/api/v1/courses/credits/all"
//    }).then(function successCallback(response) {
...
//    $http({
//    method: 'GET',
//    url:"/api/v1/courses/avgFractions/all"
//    }).then(function successCallback(response) {
//    $scope.avgFractions = response.data.data;
//    $scope.process = "";
//    }, function errorCallback(response) {
//    $scope.process = "提交数据失败！";
//    });
...
//    });
        ...
        table.bootstrapTable({
            ...
            events: {
                ...
                'click .edit': function(e, value, row, index) {
                    //formatter中点击删除按钮事件
                    //机制：click表示点击，.remove表示class名
                    window.location.href = "/admin/course/courseedit.html?id=" + row.id;//TODO:this
                },
            }
        }, ]
    });
    ...
    // 批量更新平均成绩 - 调用模态框，这样用旧的模板，直接使用jquery进行处理，后期可改进
    $("#update-avgFraction-multi-btn").click(function() {
        $.ajax({
            url: apiUrl + "/avgFraction",
            contentType: "text/plain",
            type: 'put',
            success: function(message) {
                table.bootstrapTable('refresh'); //删除后重新刷新表格
