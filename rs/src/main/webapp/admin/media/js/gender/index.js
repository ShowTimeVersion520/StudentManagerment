...
// 全局变量
var apiUrl = "/api/v1/genders";//TODO:this
...
//    $http({
//    method: 'GET',
//    url:"/api/v1/genders/genders/all"
...
//    });
    // 定义form的数据存储地方
    $scope.formData = {
        list: 0 // 初始化select的值，1为启用，参考 $scope.enableds
                    //,gender:""
            };
        ...
        table.bootstrapTable({
            ...
            events: {
                ...
                'click .edit': function(e, value, row, index) {
                    //formatter中点击删除按钮事件
                    //机制：click表示点击，.remove表示class名
                    window.location.href = "/admin/gender/genderedit.html?id=" + row.id;//TODO:this
                },
            }
        }, ]
    });
