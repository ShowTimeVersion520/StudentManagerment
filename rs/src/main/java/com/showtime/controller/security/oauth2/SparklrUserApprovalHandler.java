...
package com.showtime.controller.security.oauth2;
...
public class SparklrUserApprovalHandler
	 ...
	 * @param userAuthentication the current sysuser authentication
	 * 
	 * @return An updated request if it has already been approved by the current sysuser.
	 */
	@Override
